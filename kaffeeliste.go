...
var (
	...
	// Text im Footer
	footerText string = "Generated by Kaffeeliste"
)
...
func parseArguments() {
	...
	width = parser.Int("w", "width", &argparse.Options{Required: false, Default: 80, Help: "table width (characters per line)"})
...
// Generiert die Zeile für einen Kaffeetrinker
